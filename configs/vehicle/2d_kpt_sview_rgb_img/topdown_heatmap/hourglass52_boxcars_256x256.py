...
train_pipeline = [
    ...
    # dict(type='TopDownRandomMotionBlur', max_degree=40, prob=0.5),
    # dict(type='TopDownRandomGaussianBlur', sigma=[3, 5, 7, 9, 11], prob=0.5),
    dict(type='TopDownRandomBlur', max_degree=40, sigma=[3, 5, 7, 9, 11], prob=0.5),
